...
const translations = {
    de: {
        ...
        storyParagraph1: "Fertigo wurde 2023 aus der Frustration heraus gegründet, dass die Suche nach Handwerkern und anderen Dienstleistern oft einem Glücksspiel glich. Wir wollten eine Plattform schaffen, auf der sich Kunden auf Qualität verlassen und Anbieter faire Chancen auf neue Aufträge erhalten können.",
...
const AboutPage: React.FC = () => {
    ...
    return (
        <div className="bg-white">
            <div className="relative pt-24 sm:pt-32 pb-24 sm:pb-32 bg-primary-50">
                <div className="container mx-auto px-6 text-center">
                    <h1 className="text-4xl sm:text-6xl font-bold text-slate-900 tracking-tight mb-4">{t.missionTitle}</h1>
