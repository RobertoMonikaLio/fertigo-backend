                    ...
                    {currentStep === 3 && (
                        <div className="space-y-6 animate-fade-in">
                            ...
                            <div className="text-center pb-4 border-b border-slate-200">
                                ...
                                <h1 className="text-2xl font-bold text-slate-900">Dokumente hochladen</h1>
                                <p className="text-slate-500 mt-1 text-sm">Verifizieren Sie Ihr Unternehmen</p>
                            </div>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
                    ...
                    <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-2xl border border-slate-200/80 p-8 sm:p-12">
                        ...
                        <div className="min-h-[500px] flex flex-col">
                           ...
                           {currentStep === 3 && ( <div className="flex flex-col h-full animate-fade-in"> 
                            {/* Header */}
                            <div className="text-center mb-8 pb-6 border-b border-slate-200"> 
                                ...
                                <h2 className="text-3xl font-bold text-slate-900">Dokumente hochladen</h2> 
                                <p className="text-slate-500 mt-2 max-w-lg mx-auto">Verifizieren Sie Ihr Unternehmen für mehr Vertrauen bei Ihren Kunden</p> 
                            </div> 
                                    ...
                                    <div className="p-5 bg-white">
                                        <div className="space-y-4"> 
                                            <div className="flex items-center gap-4"> 
                                                ...
                                                <div>
                                                    <p className="font-semibold text-slate-900">Kundenschutz</p> 
                                                    <p className="text-sm text-slate-500">Schutz vor unseriösen Anbietern auf der Plattform</p> 
                                                </div>
                                            </div> 
                                            <div className="flex items-center gap-4"> 
                                                <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center flex-shrink-0">
                                                ...
                                                <div>
                                                    <p className="font-semibold text-slate-900">Qualitätssicherung</p> 
                                                    <p className="text-sm text-slate-500">Nur geprüfte und seriöse Partner werden zugelassen</p> 
                                                </div>
                                            </div> 
                                            <div className="flex items-center gap-4"> 
                                                <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center flex-shrink-0">
                                                ...
                                                <div>
                                                    <p className="font-semibold text-slate-900">Versicherungsnachweis</p> 
                                                    <p className="text-sm text-slate-500">Absicherung für Kunden im Schadensfall</p> 
                                                </div>
                                            </div> 
                                        </div>
                                    </div>
                            ...
                            <div className="flex justify-between items-center pt-8 mt-auto border-t border-slate-200"> 
                                ...
                                <button type="button" onClick={nextStep} className="bg-primary-600 text-white font-bold py-3.5 px-8 rounded-xl hover:bg-primary-700 flex items-center gap-2 shadow-lg shadow-primary-500/30 transition-all hover:shadow-xl hover:shadow-primary-500/40"> 
