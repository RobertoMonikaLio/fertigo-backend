...
const ProvidersPage: React.FC = () => {
    ...
    return (
        <div className="bg-white">
            ...
            <section id="how-it-works" className="relative bg-gradient-to-b from-slate-50 via-white to-slate-50 py-20 lg:py-32 overflow-hidden">
                {/* Subtle Background Pattern */}
                <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute top-20 left-10 w-72 h-72 bg-primary-100/40 rounded-full blur-[100px]"></div>
                    <div className="absolute bottom-20 right-10 w-96 h-96 bg-emerald-100/30 rounded-full blur-[120px]"></div>
                </div>

                <div className="container mx-auto px-6 relative z-10">
                    {/* Header */}
                    <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-24">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-100 text-primary-700 text-xs font-bold uppercase tracking-wider mb-6">
                            <RocketLaunchIcon className="w-4 h-4" />
                            In 3 Schritten zum Erfolg
                        </div>
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight mb-5">
                            {t.howItWorksTitle}
                        </h2>
                    ...
                    <div className="hidden lg:block max-w-5xl mx-auto">
                        ...
                        <div className="relative">
                            <svg className="absolute top-0 left-0 w-full h-full" viewBox="0 0 1000 400" fill="none" preserveAspectRatio="none">
                                <path 
                                    d="M 100 80 Q 300 80, 350 200 T 650 200 Q 700 200, 900 80" 
                            ...
                            <div className="relative grid grid-cols-3 gap-8">
                                ...
                                <div className="relative pt-0">
                                    <div className="group cursor-pointer">
                                        ...
                                        <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-20">
                                            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary-500 to-primary-600 text-white font-black text-xl flex items-center justify-center shadow-xl shadow-primary-500/30 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                                                01
                                            </div>
                                        </div>
                                        
                                        {/* Card */}
                                        <div className="bg-white rounded-3xl p-8 pt-12 shadow-xl border border-slate-100 group-hover:shadow-2xl group-hover:-translate-y-2 transition-all duration-300 relative overflow-hidden">
                                            {/* Decorative Corner */}
                                            <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-primary-50 to-transparent rounded-bl-[80px]"></div>
                                            
                                            {/* Icon */}
                                            <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                                                <MagnifyingGlassIcon className="w-8 h-8 text-primary-600" />
                                            </div>
                                            
                                            <h3 className="text-xl font-bold text-slate-900 mb-3">Lead entdecken</h3>
                                            <p className="text-slate-500 text-sm leading-relaxed mb-6">{t.howItWorksStep1Desc}</p>
                                            ...
                                            <div className="space-y-3 pt-4 border-t border-slate-100">
                                                <div className="flex items-center gap-3 text-sm">
                                                    ...
                                                    <span className="text-slate-600">Echtzeit-Benachrichtigungen</span>
                                                </div>
                                                <div className="flex items-center gap-3 text-sm">
                                                    <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center flex-shrink-0">
                                                        <CheckIcon className="w-3.5 h-3.5 text-emerald-600" />
                                                    </div>
                                                    <span className="text-slate-600">100% geprüfte Anfragen</span>
                                                </div>
                                            </div>
                                        </div>
                                        
                                        {/* Arrow to next */}
                                        <div className="hidden lg:flex absolute -right-4 top-1/2 transform translate-x-full -translate-y-1/2 z-10">
                                            <div className="flex items-center gap-1 text-primary-400">
                                                <div className="w-8 h-0.5 bg-gradient-to-r from-primary-400 to-primary-300"></div>
                                ...
                                <div className="relative pt-16">
                                    <div className="group cursor-pointer">
                                        {/* Floating Number Badge */}
                                        <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-20">
                                            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-sky-500 to-sky-600 text-white font-black text-xl flex items-center justify-center shadow-xl shadow-sky-500/30 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                                                02
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-white rounded-3xl p-8 pt-12 shadow-xl border border-slate-100 group-hover:shadow-2xl group-hover:-translate-y-2 transition-all duration-300 relative overflow-hidden">
                                            {/* Decorative Corner */}
                                            <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-sky-50 to-transparent rounded-bl-[80px]"></div>
                                            
                                            {/* Icon */}
                                            <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-sky-100 to-sky-50 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                                                <PencilSquareIcon className="w-8 h-8 text-sky-600" />
                                            </div>
                                            
                                            <h3 className="text-xl font-bold text-slate-900 mb-3">Angebot senden</h3>
                                            <p className="text-slate-500 text-sm leading-relaxed mb-6">{t.howItWorksStep2Desc}</p>
                                            ...
                                            <div className="space-y-3 pt-4 border-t border-slate-100">
                                                <div className="flex items-center gap-3 text-sm">
                                                    ...
                                                    <span className="text-slate-600">Direkter Kundenkontakt</span>
                                                </div>
                                                <div className="flex items-center gap-3 text-sm">
                                                    <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center flex-shrink-0">
                                                        <CheckIcon className="w-3.5 h-3.5 text-emerald-600" />
                                                    </div>
                                                    <span className="text-slate-600">Alle Projektdetails sichtbar</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="hidden lg:flex absolute -right-4 top-1/2 transform translate-x-full -translate-y-1/2 z-10">
                                            <div className="flex items-center gap-1 text-sky-400">
                                                <div className="w-8 h-0.5 bg-gradient-to-r from-sky-400 to-amber-400"></div>
                                ...
                                <div className="relative pt-0">
                                    <div className="group cursor-pointer">
                                        {/* Floating Number Badge */}
                                        <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-20">
                                            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 text-white font-black text-xl flex items-center justify-center shadow-xl shadow-amber-500/30 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                                                03
                                            </div>
                                        </div>
                                        
                                        {/* Card with Success Highlight */}
                                        <div className="bg-gradient-to-br from-white to-amber-50/50 rounded-3xl p-8 pt-12 shadow-xl border-2 border-amber-200/50 group-hover:shadow-2xl group-hover:-translate-y-2 transition-all duration-300 relative overflow-hidden">
                                            {/* Decorative Corner */}
                                            <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-amber-100 to-transparent rounded-bl-[80px]"></div>
                                            ...
                                            {/* Icon */}
                                            <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-100 to-amber-50 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                                                <TestsiegerIcon className="w-8 h-8 text-amber-600" />
                                            </div>
                                            
                                            <h3 className="text-xl font-bold text-slate-900 mb-3">Auftrag gewinnen</h3>
                                            <p className="text-slate-500 text-sm leading-relaxed mb-6">{t.howItWorksStep3Desc}</p>
                                            ...
                                            <div className="space-y-3 pt-4 border-t border-amber-200/50">
                                                <div className="flex items-center gap-3 text-sm">
                                                    ...
                                                    <span className="text-slate-600">Keine versteckten Gebühren</span>
                                                </div>
                                                <div className="flex items-center gap-3 text-sm">
                                                    <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center flex-shrink-0">
                                                        <CheckIcon className="w-3.5 h-3.5 text-emerald-600" />
                                                    </div>
                                                    <span className="text-slate-600">100% Ihr Gewinn</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="text-center mt-20">
                            <Link 
                                to="/register" 
                                className="group inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-primary-600 to-emerald-600 text-white font-bold text-lg rounded-2xl hover:from-primary-700 hover:to-emerald-700 transition-all shadow-xl shadow-primary-500/25 hover:shadow-primary-500/40 hover:-translate-y-1"
                            >
                                Jetzt durchstarten
                                <ArrowRightIcon className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                            </Link>
                            <p className="mt-4 text-sm text-slate-500">Kostenlos registrieren • Keine Kreditkarte nötig</p>
                        </div>
                    </div>

                    {/* Mobile Version - Vertical Journey */}
                    <div className="lg:hidden">
                        <div className="relative space-y-6">
                            {/* Vertical Connection Line */}
                            <div className="absolute left-7 top-8 bottom-8 w-1 bg-gradient-to-b from-primary-500 via-sky-500 to-amber-500 rounded-full"></div>

                            {/* Step 1 */}
                            <div className="relative flex gap-5">
                                <div className="relative z-10 flex-shrink-0">
                                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary-500 to-primary-600 text-white font-black text-lg flex items-center justify-center shadow-lg">
                                        01
                                    </div>
                                    {/* Arrow Down */}
                                    <div className="absolute left-1/2 -translate-x-1/2 mt-2 text-primary-400">
                                ...
                                <div className="flex-1 bg-white rounded-2xl p-5 shadow-lg border border-slate-100">
                                    ...
                                    <h3 className="text-lg font-bold text-slate-900 mb-2">Lead entdecken</h3>
                            ...
                            <div className="relative flex gap-5">
                                <div className="relative z-10 flex-shrink-0">
                                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-sky-500 to-sky-600 text-white font-black text-lg flex items-center justify-center shadow-lg">
                                        02
                                    </div>
                                    {/* Arrow Down */}
                                    <div className="absolute left-1/2 -translate-x-1/2 mt-2 text-sky-400">
                                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M10 3a1 1 0 011 1v10.586l3.293-3.293a1 1 0 111.414 1.414l-5 5a1 1 0 01-1.414 0l-5-5a1 1 0 111.414-1.414L9 14.586V4a1 1 0 011-1z" clipRule="evenodd" />
                                        </svg>
                                    </div>
                                ...
                                <div className="flex-1 bg-white rounded-2xl p-5 shadow-lg border border-slate-100">
                                    ...
                                    <h3 className="text-lg font-bold text-slate-900 mb-2">Angebot senden</h3>
                            ...
                            <div className="relative flex gap-5">
                                <div className="relative z-10 flex-shrink-0">
                                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 text-white font-black text-lg flex items-center justify-center shadow-lg">
                                        03
                                    </div>
                                </div>
                                <div className="flex-1 bg-gradient-to-br from-white to-amber-50 rounded-2xl p-5 shadow-lg border-2 border-amber-200/50">
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="w-11 h-11 rounded-xl bg-amber-100 flex items-center justify-center">
                                            <TestsiegerIcon className="w-6 h-6 text-amber-600" />
                                        </div>
                                        <span className="px-2.5 py-1 bg-emerald-100 text-emerald-700 text-xs font-bold rounded-full">Ziel!</span>
                                    </div>
                        ...
                        <div className="mt-10">
                            <Link 
                                to="/register" 
                                className="flex items-center justify-center gap-3 w-full px-6 py-4 bg-gradient-to-r from-primary-600 to-emerald-600 text-white font-bold rounded-xl shadow-lg"
                            >
                                Jetzt durchstarten
                                <ArrowRightIcon className="w-5 h-5" />
                            </Link>
                            <p className="mt-3 text-center text-xs text-slate-500">Kostenlos • Keine Kreditkarte nötig</p>
                        </div>
                    </div>
                </div>
