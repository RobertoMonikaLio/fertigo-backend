...
export const BuildingStorefrontIcon: React.FC<IconProps> = ({ className }) => (<svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 .75.75V21m-4.5 0H2.36m19.28 0H18m-9.75 0V9.75a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 .75.75V21M3 21h18M12 5.25h.008v.008H12V5.25ZM12 7.5h.008v.008H12V7.5Zm0 2.25h.008v.008H12V9.75ZM12 12h.008v.008H12V12Zm0 2.25h.008v.008H12v-.008Zm0 2.25h.008v.008H12v-.008Zm1.5-9h.008v.008h-.008V5.25Zm0 2.25h.008v.008h-.008V7.5Zm0 2.25h.008v.008h-.008V9.75Zm0 2.25h.008v.008h-.008V12Zm0 2.25h.008v.008h-.008v-.008Zm0 2.25h.008v.008h-.008v-.008ZM2.25 21v-3.75a.75.75 0 0 1 .75-.75h1.5a.75.75 0 0 1 .75.75V21m-4.5 0H.75m18 0h3.75m-4.5 0v-3.75a.75.75 0 0 1 .75-.75h1.5a.75.75 0 0 1 .75.75V21M3.375 15h17.25M6.75 15v-6a2.25 2.25 0 0 1 2.25-2.25h6a2.25 2.25 0 0 1 2.25 2.25v6" /></svg>);
export const TableCellsIcon: React.FC<IconProps> = ({ className }) => (<svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 0 1-1.125-1.125M3.375 19.5h7.5c.621 0 1.125-.504 1.125-1.125m-9.75 0V5.625m0 12.75v-1.5c0-.621.504-1.125 1.125-1.125m18.375 2.625V5.625m0 12.75c0 .621-.504 1.125-1.125 1.125m1.125-1.125h-7.5c-.621 0-1.125-.504-1.125-1.125m0 3.75V5.625m0 12.75v-1.5c0-.621.504-1.125 1.125-1.125m1.125 4.875h7.5c.621 0 1.125-.504 1.125-1.125M3.375 5.625h17.25m-17.25 0a1.125 1.125 0 0 0-1.125 1.125M3.375 5.625h7.5c.621 0 1.125.504 1.125 1.125m0-1.125v12.75m0-12.75v1.5c0 .621.504 1.125 1.125 1.125m11.25-2.625a1.125 1.125 0 0 1 1.125 1.125m-1.125-1.125h-7.5c-.621 0-1.125-.504-1.125 1.125m0-1.125v12.75m0-12.75v1.5c0 .621.504 1.125 1.125 1.125" /></svg>);
